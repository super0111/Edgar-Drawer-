...
const works = [
    { title: "Browse Sounds", text: "Find the music that brings your visuals to life." },
    { title: "Mint Your License", text: "Get licenses for NFT art and metaverse productions so you are covered for any on-chain visual projects." },
    { title: "Download and Go", text: "Grab your audio file and start creating!" },
]
    ...
    return (
        <div className={classes.featuredBody}>
            ...
            <div className={classes.work}>
                { works.map((work, i) => (
                    <div className={classes.work_field}>
                        ...
                        <div className={classes.work_text}>
                            {work.text}
                        </div>
                    </div>
                )) }
